...
public class ArtistsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Category> artists = new ArrayList<>();

        String[] artistsArr = getResources().getStringArray(R.array.artists);

        artists.add(new Category(artistsArr[0], R.drawable.firepower));
        artists.add(new Category(artistsArr[1], R.drawable.master_of_puppets));
        artists.add(new Category(artistsArr[2], R.drawable.toxicity));
        ...
        CategoryAdapter artistsAdapter = new CategoryAdapter(this, artists);
        ...
        gridView.setOnItemClickListener(new GridView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View itemClicked, int position,
                ...
                startActivity(new Intent(ArtistsActivity.this, CurrentPlaylistActivity.class)
