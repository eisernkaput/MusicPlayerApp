    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nowPlaying.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent nowPlayingIntent = new Intent(FoldersActivity.this, NowPlayingActivity.class);
        ...
        ArrayList<Category> folders = new ArrayList<>();

        String[] foldersArr = getResources().getStringArray(R.array.artists);

        folders.add(new Category(foldersArr[0], R.drawable.default_pic));
        folders.add(new Category(foldersArr[1], R.drawable.default_pic));
        folders.add(new Category(foldersArr[2], R.drawable.default_pic));
        ...
        CategoryAdapter foldersAdapter = new CategoryAdapter(this, folders);
        ...
        gridView.setOnItemClickListener(new GridView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View itemClicked, int position,
                ...
                startActivity(new Intent(FoldersActivity.this, CurrentPlaylistActivity.class)
